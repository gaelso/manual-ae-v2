...
```{r reglin, out.width=one_col, fig.cap="(ref:reglin)"}
...
```{r res1, out.width=two_col, fig.cap="(ref:res1)"}
...
```{r res2, out.width=one_col, fig.cap="(ref:res2)"}
...
```{r fBvDres, out.width=two_col, fig.cap="(ref:fBvDres)"}
...
```{r fBvD2Hres, out.width=two_col, fig.cap="(ref:fBvD2Hres)"}
...
```{r fDpol, out.width=two_col, fig.cap="(ref:fDpol)"}
...
```{r flnDHres, out.width=two_col, fig.cap="(ref:flnDlnHres)"}
...
```{r res3, out.width=two_col, fig.scap="Plot of weighted residuals against fitted values for a weighted regression", fig.cap="(ref:res3)"}
...
```{r, echo=T, eval=F}
with(sdB, plot(
  D, sdB, log="xy", xlab="Diameter (cm)", ylab="Biomass standard deviation (t)"
  ))
```
...
```{r, echo=T, eval=F}
plot(
  fitted(m), residuals(m) / dat$dbh^2, 
...
plot(
  fitted(m), residuals(m) / dat$dbh^2.5, 
  xlab="Fitted values", ylab="Weighted residuals"
  )
```
...
```{r fpond, out.width=one_col, fig.cap="(ref:fpond)"}
...
```{r fD2Hpres, out.width=two_col, fig.scap="Plot of weighted residuals against fitted values for a weighted regression of biomass against $D^2H$ for 42 trees measured in Ghana by @henry10", fig.cap="(ref:fD2Hpres)"}
...
```{r fresDD2, out.width=one_col, fig.cap="(ref:fresDD2)"}
...
```{r linh, out.width=one_col, fig.cap="(ref:linh)"}
...
```{r, echo=T, eval=F}
with(dat,plot(
  heig, Btot / dbh^2, xlab = "Height (m)", ylab = "Biomass/square of dbh (t/cm2)"
  ))
...
```{r fBD2vH, out.width=one_col, fig.cap="(ref:fBD2vH)"}

display_fig("fBD2vH")

```

```{r fHres, out.width=two_col, fig.cap="(ref:fHres)"}
...
with(dat, plot(
  1 / dbh, Btot / dbh^2, 
  xlab = "1/Diameter (/cm)", ylab = "Biomass/square of dbh (t/cm2)"
  ))
...
```{r fBD2vD, out.width=one_col, fig.cap="(ref:fBD2vD)"}

display_fig("fBD2vD")

```

```{r finvDres, out.width=two_col, fig.cap="(ref:finvDres)"}
