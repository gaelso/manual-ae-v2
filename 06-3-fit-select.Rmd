...
```{r fpredB, fig.ncol=2, fig.subcap = c("", "", "", ""), out.extra="", fig.show='hold', fig.scap="Biomass predictions by different tables fitted to data from 42 trees measured in Ghana by @henry10", fig.cap="(ref:fpredB)"}
