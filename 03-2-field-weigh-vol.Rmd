...
```{r ka, fig.scap="Trimming shea trees (*Vitellaria paradoxa*) in north Cameroon", fig.cap="(ref:ka)"}
...
```{r archim, out.width='60%', fig.cap="(ref:archim)"}

knitr::include_graphics(paste0(fig_path, "/archim.png"), auto_pdf = TRUE)
