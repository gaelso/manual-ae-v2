...
- an exhaustive or statistical inventory of the trees growing;
- models to evaluate carbon stocks from the dimensions of the individuals measured;
- an evaluation of the biomass contained in the necromass (standing dead wood) and in understorey vegetation.
...
- the variance of the estimated parameters is not minimal;
- this variance is biased; and 
- residual variance is poorly estimated [@cunia64; @parresol93; @gregoire89].
