...
plan %>%
  image_draw()
## Image top text
text(170, 380, bquote(italic("n") ~ "/2 trees"), family = "mono", cex = 2)
text(450, 330, "Volume?"                       , family = "mono", cex = 2)
text(890, 180, bquote(italic("n") ~ "/2 trees"), family = "mono", cex = 2)
## Bottom arrow
rect(xleft = 100, xright = 1040, ybottom = 519, ytop = 520)
text(1035, 521, ">", cex = 3)
## Bottom text
# text(1870, 420, bquote(italic("Size " ~ D^2*H)), family = "serif", cex = 3)
