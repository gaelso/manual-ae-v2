...
```{r plan, dev='tikz', fig.align='center', out.width='100%', fig.scap="Sampling plan optimizing volume prediction precision for a particular tree", fig.cap="(ref:plan)"}

#plot.new()
grid.raster(plan)
grid.text("$n/2$ trees", x = 0.16, y = 0.46)
grid.text("Volume?"    , x = 0.38, y = 0.54)
grid.text("$n/2$ trees", x = 0.72, y = 0.73)
grid.text("Size $D^2H$", x = 0.95, y = 0.27)
grid.text("$D^2H$"     , x = 0.38, y = 0.24)
grid.text("$\\Delta$"  , x = 0.25, y = 0.18)
grid.text("$\\Delta$"  , x = 0.5 , y = 0.18)
