...
```{r badR2, fig.scap="", fig.cap="(ref:badR2)"}

knitr::include_graphics(paste0(fig_path, "/badR2.png"), auto_pdf = TRUE)
...
```{r fBvD, fig.cap="(ref:fBvD)"}

knitr::include_graphics(paste0(fig_path, "/fBvD.png"), auto_pdf = TRUE)
...
```{r badex, fig.cap="(ref:badex)"}

knitr::include_graphics(paste0(fig_path, "/badexplo.png"), auto_pdf=TRUE)
...
```{r cX1, fig.cap="(ref:cX1)"}

knitr::include_graphics(paste0(fig_path, "/conditioX1.png"), auto_pdf = TRUE)
...
```{r y0X1, fig.cap="(ref:y0X1)"}

knitr::include_graphics(paste0(fig_path, "/ordonX1.png"), auto_pdf = TRUE)
...
This conditioning can, in principle, be extended to any number of effect variables.For three effect variables $X_1$,
$X_2$, $X_3$ for example, we could explore the relation between $Y$ and $X_3$ with $X_1$ and $X_2$ fixed and note $f$ the function defining this relation and $\theta(X_1,\ X_2)$ the parameters of $f$ (that potentially depend on $X_1$ and $X_2$):
\[
...
```{r fcond, fig.scap="(ref:fcond-short)", fig.cap="(ref:fcond)"}

knitr::include_graphics(paste0(fig_path, "/fcondi.png"), auto_pdf = TRUE)

``` 

```{r flmcond, fig.scap="(ref:flmcond-short)", fig.cap="(ref:flmcond)"}

knitr::include_graphics(paste0(fig_path, "/flmcond.png"), auto_pdf = TRUE)
...
```{r wii1, fig.cap="(ref:wii1)"}

knitr::include_graphics(paste0(fig_path, "/whoisit1.png"), auto_pdf = TRUE)
...
```{r wii2, fig.cap="(ref:wii2)"}

knitr::include_graphics(paste0(fig_path, "/whoisit2.png"), auto_pdf = TRUE)
...
```{r wii3, fig.cap="(ref:wii3)"}

knitr::include_graphics(paste0(fig_path, "/whoisit3.png"), auto_pdf = TRUE)
...
```{r flnBvlnD, fig.cap="(ref:flnBvlnD)"}

knitr::include_graphics(paste0(fig_path, "/flnBvlnD.png"), auto_pdf = TRUE)
...
```{r flnBvD2H, fig.cap="(ref:flnBvD2H)"}

knitr::include_graphics(paste0(fig_path, "/flnBvD2H.png"), auto_pdf = TRUE)
...
```{r adml, fig.scap="Power model with additive or multiplicative error", fig.cap="(ref:adml)"}

knitr::include_graphics(paste0(fig_path, "/addmult.png"), auto_pdf = TRUE)
