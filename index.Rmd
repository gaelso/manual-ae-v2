...
eywords: "allometric equation, biomass table, volume table"
documentclass: book
#lof: yes
#lot: yes
fontsize: 11pt
...
if (book_format %in% c("html", "latex")) {
  ...
  if (book_format == "latex") {
    ...
    knitr::opts_chunk$set(fig.align='center', out.width='60%', class.source="Rchunk", class.output="Rout") ## NOT USED: fig.pos='H', 
    one_col <- '40%'
    two_col <- '80%'
  }
}
