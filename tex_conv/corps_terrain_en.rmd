...
\caption[Trimming shea trees (*Vitellaria paradoxa*) in north Cameroon]{Trimming shea trees (*Vitellaria paradoxa*) in north Cameroon (photo: R. Peltier).\label{ka}}
\end{photo}
...
\caption[Superimposition of different sampling methods (cores, excavations by cubes, partial Voronoi excavation, total Voronoi excavation)]{Left, superimposition of different sampling methods (cores, excavations by cubes, partial Voronoi excavation, total Voronoi excavation), from @levillain11 (photo: C. Jourdan). Right, manual excavation of large roots in a rubber tree plantation in Thailand (photo: L. Saint-Andr�).\label{evor}}
\end{photo}
