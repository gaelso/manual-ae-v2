...
```{r compart3, dev='pdf', cache=TRUE, out.width="100%", fig.cap="Example of tree compartmentalization for a biomass and nutrient content campaign on beech in France."}
