...
```{r compart2, out.width="100%", fig.cap="Example of tree compartmentalization for a biomass and nutrient content campaign on beech in France."}
...
```{r compart3, dev='tikz', fig.process = pdf2png, out.width="100%", fig.cap="Example of tree compartmentalization for a biomass and nutrient content campaign on beech in France."}

#invisible(plot.new())
grid.arrange(grImport::pictureGrob(comparts_vec), ncol = 2)
grid.text(label = "Leaves: total weight and sample taken for \\\\moisture content", 
          x = 0.4, y = 0.75, just = 0
          )
# grid.text(label = 'Branches (cross cuts \\char"2205 $\\geq$ 20 cm; 20 cm > $\\geq$ 7 cm;' ,
#           x = 0.3, y = 0.65, just = 0
#           )
# grid.text(label = "Branches (cross cuts \U2205 $\\geq$ 20 cm; 20 cm > \U2205 $\\geq$7 cm;",
#           x = 0.3, y = 0.65, just = 0
#           )
# grid.text(label = bquote("7 cm  > \U2205" >= "4 cm; 4 cm > \U2205): weighed and sample taken of"),
#           x = 0.3, y = 0.61, just = 0
#           )
